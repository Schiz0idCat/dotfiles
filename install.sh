...
ln -sf ~/dotfiles/terminal/kitty/kitty.conf ~/.config/kitty/
ln -sf ~/dotfiles/terminal/kitty/theme.conf ~/.config/kitty/
...
ln -sf ~/dotfiles/nvim/plugins/indent.lua ~/.config/nvim/lua/plugins/
